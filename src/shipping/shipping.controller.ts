...
export class ShippingController {
  ...
  webhook(@Headers("authorization") authorization: string | undefined, @Headers("x-biteship-webhook-secret") secret: string | undefined, @Body() body: unknown) { this.biteship.verifyWebhookSecret(authorization, secret); return this.biteship.handleWebhook(body).then(success); }
